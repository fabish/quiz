        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href=""></a></li>
                    <li><a href="<?php echo base_url(route_to('register'));?>">Informcion1</a></li>
                    <li><a href="<?php echo base_url(route_to('forget'));?>">Informcion2</a></li>
                    <li><a href="<?php echo base_url();?>">Informcion3</a></li>
                    <li><a href="#"></a></li>
                </ul>
